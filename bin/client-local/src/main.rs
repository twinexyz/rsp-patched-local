...
use rsp_client_executor::{
    io::ClientExecutorInput, BlockInfo, ChainVariant, ClientExecutor, PublicCommitment,
};
...
pub fn main() {
    ...
    let public_commitment =
        PublicCommitment { from_block, to_block, batch_hash: keccak256(pub_commitment_slice) };
